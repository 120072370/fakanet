...
<link href="/lin/green/css/style.css" rel="stylesheet" type="text/css" />
<link href="/lin/green/css/nyro.css" rel="stylesheet" type="text/css" />
...
<div class="bottom_shadow pngFix"></div></div>
	...
	<div id="main">
		...
		<input type="hidden" name="api_username" value="<?php echo _G('username') ?>" />
		    ...
		    <tr>
				...
				<td width="400">商户网站：<a href="<?php echo $siteurl ?>" target="_blank"><span><?php echo $siteurl ?></span></td>
			</tr>
		    <tr>
				...
				<td style="text-align:right"><a href="report.php?uid=<?php echo $userid ?>&t=1" class="nyroModal" id="report" style="color:red;font-weight:bold;">举报投诉</a></td>
			</tr>
			<tr>
...
<!--
		...
		<div id="submit"><input type="image" id="submit" src="green/images/button.gif" /></div>
