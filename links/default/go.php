	...
	<div id="main">
		...
		<div id="step_two">
		    <ul id="select_pay">
				...
				<input type="radio" style="display:none" name="paytype" value="card" id="card" <?php echo $is_paytype==2 ? 'checked' : '' ?> /> <label for="card"><img src="default/images/card.gif" align="absmiddle" /> 充值卡支付</label>
				</li>
				<!--<?php endif; ?>

			    <?php if($is_alipay_display): ?>
			    <li<?php echo $is_paytype==3 ? ' class="selected"' : '' ?>>
				<input type="radio" style="display:none" name="paytype" value="alipay" id="alipay" <?php echo $is_paytype==3 ? 'checked' : '' ?> /> <label for="alipay"><img src="default/images/bank.gif" align="absmiddle" /> 支付宝支付</label>
				</li>
				<?php endif; ?>

			    <?php if($is_tenpay_display): ?>
			    <li<?php echo $is_paytype==4 ? ' class="selected"' : '' ?>>
				<input type="radio" style="display:none" name="paytype" value="tenpay" id="tenpay" <?php echo $is_paytype==4 ? 'checked' : '' ?> /> <label for="tenpay"><img src="default/images/bank.gif" align="absmiddle" /> 财付通支付</label>
				</li>-->
				<?php endif; ?>
			</ul>
