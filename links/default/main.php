...
<meta http-equiv="Content-type" content="text/html;charset=utf-8" />
    ...
    <link href="/lin/default/css/index.css" rel="stylesheet" type="text/css" />
	<link href="/lin/default/css/nyro.css" rel="stylesheet" type="text/css" />
 	<link href="/lin/default/css/style.css" rel="stylesheet" type="text/css" />
                    ...
                    <ul>
                                <li>
                                   ...
                                   <li>
                                    <a href="javascript:void(0)">
                                    <label for="bank(45)">
                                            <input type="radio" name="pid" value="QQCODE" myval="4" id="bank(45)" /><img src="/lin/default/images/QQCODE.gif" title="QQ钱包" disabled="disabled"/>
                                        </label>
                                    </a>
                                </li>
                    </ul>
