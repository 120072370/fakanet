...
<title><?php echo $title ?></title>
   <script src="/lin/baibian/baibian.php" type="text/javascript"></script>
    <link href="/lin/orange/css/nyro.css" rel="stylesheet" type="text/css" />
	...
	<div id="main">
		...
		<input type="hidden" name="api_username" value="<?php echo _G('username') ?>" />
		    ...
		    <tr>
				...
				<td width="400">商户网站：<a href="<?php echo $siteurl ?>" target="_blank"><span><?php echo $siteurl ?></span></a></td>
			</tr>
		    <tr>
		...
		<div class="step">
		  <div style="float: right; padding-right: 46px;"> 可用手机扫描二维码手机访问购买</div>
		  <img src="green/images/step_1.gif" align="absmiddle" />&nbsp;&nbsp;第一步：选择商品</div>
		...
		<?php endif; ?>
			...
			<li><span class="red">*</span> 单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价：<strong class="red" id="price">0.00</strong> 元<input type="hidden" name="paymoney" value="" /><input type="hidden" name="danjia" value="" /></li>
			...
			<li style="height:22px;line-height:22px;"><input type="checkbox" name="isemail" value="1" id="isemail" /> <label for="isemail">交易成功后同时也将支付结果发送到我的邮箱!</label> 
		...
		<div id="step_two">
		    <ul id="select_pay">
				...
				<input type="radio" style="display:none" name="paytype" value="bank" id="bank" <?php echo $is_paytype==1 ? 'checked' : '' ?> /> <label for="bank"><img src="default/images/bank.gif" align="absmiddle" /> 快捷支付</label>
				</li>
				<?php endif; ?>
			 ...
			 <!--php if($is_alipay_display): ?>
				...
				<?php if($is_tenpay_display): ?>
			    <li<?php echo $is_paytype==4 ? ' class="selected"' : '' ?>>
				<input type="radio" style="display:none" name="paytype" value="tenpay" id="WEIXIN" <?php echo $is_paytype==4 ? 'checked' : '' ?> /> <label for="WEIXIN"><img src="default/images/bank.gif" align="absmiddle" /> 微信付款</label>
				</li>
				<?php endif; ?>-->
			</ul>
			...
			<div class="paylist">
				...
				<li><input name="pid" type="radio" value="QQCODE" /> <img src="/lin/default/images/QQCODE.gif" alt="QQ钱包" align="absmiddle" /></li>
                  <!--i><input name="pid" type="radio" value="ICBC-NET" /> <img src="default/images/ICBC-NET.gif" alt="中国工商银行" align="absmiddle" /></li>
				...
				<div id="WEIXINs" style="<?php echo $is_paytype==4 ? 'display:block' : 'display:none' ?>">
					<ul>
