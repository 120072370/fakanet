...
<title>支付结果</title>
<style>
body {margin:20px auto; padding:0; text-align:center; font-family:"Microsoft YaHei",Verdana,Arial; background:#fff; font-size:12px; color:#333; line-height:22px;}
...
<div id="main1">
	<dl class="cuowuDl">
    <span><img src="tpl/default/images/success.gif" /></span>
        ...
        <dd><button style="margin:10px auto; width:190px; color:#fff; background:url(tpl/default/images/button_bg.jpg) no-repeat; height:33px; border:0;cursor:pointer; font-weight:bold; text-align:center;" type="button" onclick="window.location.href='orderquery.htm?orderid=<?php echo $orderid ?>'" name="tiqu" id="tiqu">立即查看支付结果</button>
        </dd>       
    </dl>
</div>
</body>
