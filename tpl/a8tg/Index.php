...
<div class="ad m10">
            <div id="focus">
                <ul style="left: 0px; width: 2800px;">
                    <li><a target="_blank">
                        <img title="永纯发卡" alt="HappyNewYear" src="tpl/a8tg/Images/2.jpg"></a></li>
                    <!--<li><a target="_blank">
                        <img title="永纯发卡" alt="永纯发卡" src="tpl/a8tg/Images/1.jpg"></a></li>
                    <li><a target="_blank">
                        <img title="永纯发卡" alt="永纯发卡" src="tpl/a8tg/Images/2.jpg"></a></li>
                    <li><a target="_blank">
                        <img title="永纯发卡" alt="永纯发卡" src="tpl/a8tg/Images/3.jpg"></a></li>-->
                </ul>
            </div>   
            <div class="new_release">
                ...
                <div class="new_release_right gray">
                    <span class="ico"></span>
                    <iframe id="newBillsIframe" height="50" marginheight="0" border="0" 
                    src="tpl/a8tg/newBillsList.php" frameborder="0" width="520" 
        ...
        <div class="btnlist">
            ...
            <div class="news_login_right">
                ...
                <ul id="logined">
                	...
                	?>
                	<li>用户名：<?php echo $_SESSION['login_username'];?></li>
                	<li>上次登录IP：<?php echo  $re["logip"];?></li>
                	<li><a href="/usr/orders.php">订单管理</a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="/usr/userLogs.php">登录日志</a></li>
                	<li><a href="/usr" style="background: #42B6D6; color: #fff; padding: 10px; font-size: 15px;">快捷登录</a> &nbsp; &nbsp;<a href="/usr/login.php?action=logout">退出登录</a></li>
                </ul>
                <?php }?>
            </div>
    ...
    <div class="center">
        <div class="game_content">
                    ...
                    <ul>
                       <div style="width:674px;float:left;overflow:hidden" class=game_tab>&nbsp;<br><img title=自动发卡平台 alt=自动发卡平台 src="tpl/a8tg/images/9.jpg"></A> </div>
