            ...
            <form id="reg" name="reg" action="regsave.htm" method="POST">
              ...
              <img onclick="javascript:this.src = this.src + '?t=new Date().getTime()';" style="border: 1px solid #bcbcbc;" src="/includes/libs/chkcode.htm" align="absmiddle" title="点击刷新验证码">
                    ...
                    <li>
                        ...
                        <input type="text" class="middle code" name="reginfo[phonecode]" id="phonecode" maxlength="10">
                        &nbsp;
                  <input type="button" id="sendcode" class="sendcode" value="发送验证码" />
                        &nbsp;
                <span id="phonecodeTip" class="onShow">请填写验证码</span>
                    </li>
                    <li class="info1">
