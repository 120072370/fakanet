...
<form id="reg" name="reg" action="regsave.htm" method="POST" >
    <div id="register_main">
		<div class="register_main_content">
			...
			<td class="r_o_i"><input type="text" name="reginfo[email]" readonly id="newemail" /></td>
			...
			<td class="r_o_m"><span id="is_superman_userTip"></span></td>
			</tr>
			...
			<td class="r_o_m"><span id="superman_userTip">&nbsp;使用上级推荐，请务必填写推荐人的商户编号。</span></td>
			</tr>
			</table>
