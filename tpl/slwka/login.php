...
<link href="tpl/slwka/Css/login.css" rel="stylesheet" type="text/css">
	...
	<div class="news_login">
        <div class="center">
            <div class="left" style="margin: 20px 0 0;">
                <img src="tpl/slwka/images/login_left_1.png"></div>
                ...
                <ul> 
                    ...
                    <li>
                        <div style="float: left; margin-top: 5px; margin-left: -10px">
                            <input type="image" name="hlkOK" id="hlkOK" tabindex="4" src="tpl/slwka/images/login_dl_1.png" onclick="return Login();">
                        </div>
