				...
				<form id="Default" runat="server" action="userlogin.htm" method="post">
				  ...
				  <div class="oz">
				    <div class="oz k fl">
					    ...
					    <p><img src="includes/libs/chkcode.htm" width="80" height="40" align="absmiddle" title="点击刷新验证码" onclick="javascript:this.src=this.src+'?t=new Date().getTime()';" /></p>
					    <table width="842" border="0">
                          <tr>
                            <td width="659">&nbsp;</td>
                            <td width="173"><div align="right"><span class="oz k fl STYLE1"><a href="/register.htm">申请账号</a></span></div></td>
                          </tr>
                        </table>
