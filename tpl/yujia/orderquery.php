...
<?php if(!defined('WY_ROOT')) exit; ?>
	...
	<div id="guanyu" class="w">
        ...
        <div class="search_title">
			...
			<img style="cursor:pointer" onclick="if($('[name=kw]').val()){s.submit();}else{$('[name=kw]').focus();alert('请填写查询内容！');}" src="/tpl/yujia/images//Search_bnt.gif" />
			</td>
			</tr>
			</table>
		    </form>
