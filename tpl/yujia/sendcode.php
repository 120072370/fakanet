...
<div id="guanyu" class="w">
		<h2 class="n">申请商户<span><<</span></h2>
			<div class="about_cont simsun">
  


	<script src="tpl/yujia/js/city.js" type="text/javascript"></script>
<script src="tpl/yujia/js/formValidator_min.js" type="text/javascript"></script>
<script src="tpl/yujia/js/formValidatorRegex.js" type="text/javascript"></script>
<form id="reg" name="reg" action="regsave.htm" method="POST" >
		...
		<div class="register_main_content">
			...
			<table>
			<tr>
			<td class="r_o_t" width="220"><div align="right"><span>*</span> 用户名：</div></td>
			<td width="302" class="r_o_i"><div align="right">
			  <input type="text" name="reginfo[username]" id="newusername" />
			  </div></td>
			<td class="r_o_m" width="706"><div align="left"><span id="newusernameTip">请填写要注册的商户名</span></div></td>
			</tr>

			<tr>
			<td class="r_o_t"><div align="right"><span>*</span> 邮箱地址：</div></td>
			<td class="r_o_i"><div align="right">
			  <input type="text" name="reginfo[email]" id="newemail" />
			  </div></td>
			<td class="r_o_m"><div align="left"><span id="newemailTip">请填写您的邮箱地址</span></div></td>
			</tr>

			<tr>
			<td class="r_o_t"><div align="right"><span>*</span> 手机号码：</div></td>
			<td class="r_o_i"><div align="right">
			  <input type="text" name="reginfo[phone]" id="newmobile" />
			  </div></td>
			<td class="r_o_m"><div align="left"><span id="newmobileTip">请填写您的手机号码</span></div></td>
			</tr>

			<tr>
			<td class="r_o_t"><div align="right"><span>*</span> 身份证号：</div></td>
			<td class="r_o_i"><div align="right">
			  <input type="text" name="reginfo[idcard]" id="newidcard" />
			  </div></td>
			<td class="r_o_m"><div align="left"><span id="newidcardTip">请填写身份证号码</span></div></td>
			</tr>

			<tr>
			<td class="r_o_t"><div align="right"><span>*</span> 联系QQ：</div></td>
			<td class="r_o_i"><div align="right">
			  <input type="text" name="reginfo[qq]" id="newqq" />
			  </div></td>
			<td class="r_o_m"><div align="left"><span id="newqqTip">请填写您的QQ号码</span></div></td>
			</tr>

			<tr>
			<td class="r_o_t"><div align="right"><span>*</span> 密码：</div></td>
			<td class="r_o_i"><div align="right">
			  <input type="password" name="reginfo[password]" id="password1" />
			  </div></td>
			<td class="r_o_m"><div align="left"><span id="password1Tip">请填写密码</span></div></td>
			</tr>

			<tr>
			<td class="r_o_t"><div align="right"><span>*</span> 密码确认：</div></td>
			<td class="r_o_i"><div align="right">
			  <input type="password" name="reginfo[confirmpassword]" id="password2" />
			  </div></td>
			<td class="r_o_m"><div align="left"><span id="password2Tip">请再次输入确认密码</span></div></td>
			</tr>
			</table>
			...
			<td class="r_o_m"><div align="left"><span>&nbsp; 请选择您的开户银行，注册后不能修改</span></div></td>
			</tr>
			...
			<td class="r_o_m"><div align="left"><span id="residecityTip">请选择您的开户行所在城市，注册后不能修改</span></div></td>
			</tr>

			<tr class="pt bank">
			<td class="r_o_t"><span>*</span> 支行地址：</td>
			<td class="r_o_i"><input type="text" name="reginfo[addr]" id="address" /></td>
			<td class="r_o_m"><div align="left"><span id="addressTip">&nbsp;请填写开户行准确的地址信息，不清楚的可以暂时不填写</span></div></td>
			</tr>

			<tr class="pt bank">
			<td class="r_o_t"><span>*</span> 收款账号：</td>
			<td class="r_o_i"><input type="text" name="reginfo[card]" id="ubank_no1" /></td>
			<td class="r_o_m"><div align="left"><span id="ubank_no1Tip">请填写您的账号，注册后不能修改</span></div></td>
			</tr>

			<tr class="pt alipay">
			<td class="r_o_t"><span>*</span> 支付宝账号：</td>
			<td class="r_o_i"><input type="text" name="reginfo[alipay]" id="alipay" /></td>
			<td class="r_o_m"><div align="left"><span id="alipayTip">请填写您的支付宝账号，注册后不能修改</span></div></td>
			</tr>

			<tr class="pt tenpay">
			<td class="r_o_t"><span>*</span> 财付通账号：</td>
			<td class="r_o_i"><input type="text" name="reginfo[tenpay]" id="tenpay" /></td>
			<td class="r_o_m"><div align="left"><span id="tenpayTip">请填写您的财付通账号，注册后不能修改</span></div></td>
			</tr>

			<tr>
			<td class="r_o_t"><span>*</span> 真实姓名：</td>
			<td class="r_o_i"><input type="text" name="reginfo[realname]" id="ubank_user" /></td>
			<td class="r_o_m"><div align="left"><span id="ubank_userTip">请填写您的姓名，注册后不能修改</span></div></td>
			</tr>

			<tr>
			<td class="r_o_t"><span>*</span> 推荐上级：</td>
			<td class="r_o_i"><input type="checkbox" name="is_superman" id="is_superman" style="width:20px;padding:0;margin:0;"><label for="is_superman">&nbsp;填写推荐上级商户编号,无上级可以不勾选此选项!

</label></td>
			<td class="r_o_m"><div align="left"><span id="is_superman_userTip"></span></div></td>
			</tr>

			<tr id="s-m" style="display:none">
			<td class="r_o_t"><span>*</span> 上级编号：</td>
			<td class="r_o_i"><input type="text" name="reginfo[superman]" id="superman_user" /></td>
			<td class="r_o_m"><div align="left"><span id="superman_userTip">&nbsp;使用上级推荐，请务必填写推荐人的商户编号。</span></div></td>
			</tr>
			</table>
...
$(function(){
	...
	$("#newemail").formValidator({onshow:"请填写您的邮箱地址",onfocus:"用于找回密码、接收校验信息",oncorrect:"邮箱填写完成",defaultvalue:"<?php echo isset($email)? $email : '@'?>"}).inputValidator({min:6,max:100,onerror:"您填写的邮箱长度不正确，请确认"}).regexValidator({regexp:"^([\\w-.]+)@(([[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.)|(([\\w-]+.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(]?)$",onerror:"您填写的邮箱格式不正确，请确认"});
	$("#newmobile").formValidator({onshow:"请填写您的手机号码",onfocus:"请填写您的手机号码",oncorrect:"手机号码填写完成",onempty:"手机号码必须填写"}).inputValidator({min:11,max:11,onerror:"手机号码必须是11位"});
