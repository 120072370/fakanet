...
<script src="tpl/skyblue/js/city.js" type="text/javascript"></script>
<script src="tpl/skyblue/js/formValidator_min.js" type="text/javascript"></script>
<script src="tpl/skyblue/js/formValidatorRegex.js" type="text/javascript"></script>
  ...
  <div class="center">
   ...
   <div id="register_main">
		...
		<div class="register_option line"><input type="radio" name="reginfo[istg]" id="" value="0" checked="checked" />商户</label>
		    ...
		    <div style="width:600px" id=navc><ol><a class=navc_on>用户注册</A></ol></div>
			<table>
			<tr>
			<td class="r_o_t" width="90"><span>*</span> 用户名：</td>
			<td class="r_o_i"><input type="text" name="reginfo[username]" id="newusername" /></td>
			<td class="r_o_m" width="500"><span id="newusernameTip">请填写要注册的商户名</span></td>
			</tr>
			...
			<table>
			<tr>
			<td class="r_o_t" width="90"><span>*</span> 收款方式：</td>
			<td class="r_o_i">
			...
			<td class="r_o_m" width="500"><span>&nbsp; 请选择收款方式</span></td>
			</tr>
			...
			<tr class="pt alipay" style="display: none;">
			...
			<tr class="pt tenpay" style="display: none;">
			...
			<div id="register_agreement_container">
				<div id="agreement_content">
					<h1 align="center">
						...
						<?php echo $this->config['sitename'] ?>多途径支付平台</strong>（以下简称“<?php echo $this->config['sitename'] ?>”）依照本协议及其相关操作规则提供基于互联网的支付网关服务（以下简称“支付网关服务”或“服务”），为申请获得此服务，服务使用人（以下称“用户”）须同意本协议的全部条款并按照“<?php echo $this->config['sitename'] ?>”的提示（包括但不限于页面、邮件等）完成全部的注册程序。用户在进行注册程序过程中点击标示为"同意"的按钮或链接即表示用户完全同意接受本协议项下的全部条款。<br />
						<br />
						...
						1.4 “<?php echo $this->config['sitename'] ?>”仅提供支付网关服务，用户为使用此服务而需要的相关设备（包括但不限于电脑、调制解调器及其它与接入互联网有关的装置）及所需的费用（包括但不限于接入互联网而支付的电话费及上网费）均由用户自行负担。</h1>
					<p>
