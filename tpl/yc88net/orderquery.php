...
<div class="content">
	<div class="page_gonggao">
		<div class="page_header">
			<h1>关于我们</h1>
			<div class="recent"> <span>当前位置：<a href="/">首页 </a> > 订单查询</span> </div>
		</div>
		...
		<div class="page_content">
			<div class="left_nav">
				<ul>
					...
					<li class="nav_current"><a href="/about.htm">订单查询</a></li>
				</ul>
			</div>
			
			<div class="center_text">
				<h2>订单查询</h2>
			  <p> <div class="news_cearch">
...
<!--<div id="search_main">-->
        <div class="search_title">
			...
			<img style="cursor:pointer" onclick="if($('[name=kw]').val()){s.submit();}else{$('[name=kw]').focus();alert('请填写查询内容！');}" src="tpl/skyblue/images/search_button.png" />
			</td>
			</tr>
			</table>
			</form>
...
<?php if(!$st && !$kw): ?>
		<div class="search_tip">
			...
			<p><span>联系方式查询：</span>订单提交时您所预留的联系方式（QQ号码、手机号码、E-mail）订单查询凭证信息。
...
<?php if($st=='orderid' && $kw!=''): ?>
		<div class="search_result">
		   ...
		   <p style="display:block;float:right;position:relative;margin-top:-10px;padding-right:10px"><a href="links/report.php?uid=<?php echo $userid ?>&t=1" class="nyroModal" id="report" style="color:red">举报投诉</a></p>
			<div class="search_list">
                <table>
				    <tr>
					<th width="20%">支付时间</th>
