                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button class="btn btn-primary sendcode" id="sendcode">发送短信验证码</button>
                        </span>
                    </div>
                    <span id="newmobileTip" class="onShow">请填写您的手机号码</span>
                </div>
                <div class="form-group">
                    <label>手机验证码<small>(*必填)</small></label>
                    <input class="form-control" id="phonecode" name="reginfo[phonecode]" required="" maxlength="5" type="text">

                    <span id="phonecodeTip" class="onShow"></span>
                </div>

                <strong style="font-size: 14px; color: red">
                    申明：赌博、淫秽色情、百度云盘、黄色论坛邀请码、诱导交友、欺诈钓鱼等类别禁止注册，一经发现封停账号。
                    所注册信息 将提交有关部门.追究法律责任. 敬请各商户自律！！
                </strong>
                <div class="form-group">
                    <label for="agree">
                        <input id="agree" name="reginfo[agree]" checked="" type="checkbox">
                        <a href="/statement.htm" target="_blank">阅读并同意用户注册协议</a></label>
                     <label  class="onError">注册完成后，请立即完善商户收款信息及店铺基本信息
                        </label>
                </div>
                <div class="form-group">
