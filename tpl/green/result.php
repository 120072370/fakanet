...
<div id="main1">
	<dl class="cuowuDl">
    <span><img src="tpl/green/common/images/success.gif" /></span>
        ...
        <dd><button style="margin:10px auto; width:190px; color:#fff; background:url(tpl/green/common/images/button_bg.jpg) no-repeat; height:33px; border:0;cursor:pointer; font-weight:bold; text-align:center;" type="button" onclick="window.location.href='orderquery.htm?orderid=<?php echo $orderid ?>'" name="tiqu" id="tiqu">立即查看支付结果</button>
        </dd>       
    </dl>
</div>
</body>
