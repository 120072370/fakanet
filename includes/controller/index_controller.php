...
class index_controller{
	...
	function newslist(){
        ...
        //新增加的控制网站首页新闻展示和新闻资讯内容展示 
		// STERT CODE
	    $re=$this->db->query("SELECT addtime,title,id FROM faka_news WHERE classid='3' order by id DESC");	
		$num=0;$result=array();
	...
	function pagecontent(){
		switch($this->mod){
            case 'newslist': $title='最新动态'; break;
