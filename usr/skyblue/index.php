...
<div class="row">
    <div class="col-sm-3">
        ...
        <div class="tile-progress tile-blue">
            <div class="tile-header" style="padding-bottom: 10px;">
                <h3>账户信息</h3>
                <p>店铺信息完善度：<?php echo $safe_num;?>%</p>
            </div>

              <div class="tile-progressbar" style="height:17px;">
               <!-- <span data-fill="<?php echo $safe_num;?>%" class="progress-bar progress-bar-danger" style="width: <?php echo $safe_num;?>%;"></span>-->
            ...
            <div class="tile-footer">
                ...
                <p>
                    ...
                    商家级别：<?php echo GetUserLevel($info_user['level']) ?>
                </p>
                <span>
                    ...
                    <a href="#" class="btn btn-info btn-sm">支付宝收款</a>
                    <?php elseif($info_userinfo['ptype']==1):?>
                    <a href="#" class="btn btn-info btn-sm">银行收款</a>
                    <?php elseif($info_userinfo['ptype']==3):?>
                    <a href="#" class="btn btn-info btn-sm">财付通收款</a>
                    <?php elseif($info_userinfo['ptype']==4):?>
                    <a href="#" class="btn btn-info btn-sm">微信收款</a>
                    <?php endif?>
                    <?php endif?>
                </span>
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-success" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <script src="/usr/skyblue/js/echarts-all.js"></script>
                <script>
