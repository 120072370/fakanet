            ...
            <div class="panel-body">
				...
				<div class="main">
					<div style="padding:0 10px 10px 10px">
						...
						时间范围：
                            <input type="text" name="fdate" data-format="yyyy-mm-dd" class="input datepicker" style="width:150px" id="txtDate" size="10" readonly="readonly" value="<?php echo $fdate ?>" />&nbsp;
						至 <input type="text" name="tdate" class="input datepicker" data-format="yyyy-mm-dd" style="width:150px" id="txtDate1"  size="10" readonly="readonly" value="<?php echo $tdate ?>" />&nbsp;&nbsp;

						支付状态：<select name="t" class="search_select">
						...
						支付类型：<select name="channelid" class="search_select">
						...
						商品类型：<select name="is_api" class="search_select">
						...
						查询类别：<select name="st" class="search_select">
						...
						<input type="text" name="kw" placeholder="输入关键词" class="input" value="<?php echo $kw ?>" />
				    ...
				    <table class="table table-bordered table-responsive" cellspacing="1">
						...
						<th  class="border_right border_bottom">状态</th>
						<th  class="border_bottom">管理</th>
						</tr>
                            </thead>
						<?php if($lists): ?>
						<?php 
						...
						<?php endforeach; ?>
						<tr><td colspan="8" class="bg" style="padding-left:10px"><?php echo $pagelist ?></td></tr>
						<?php else: ?>
						<tr><td colspan="8">
                            <div class="alert alert-warning">暂无记录</div></td></tr>						
						<?php endif; ?>
					</table>
				</div>
                </div>
