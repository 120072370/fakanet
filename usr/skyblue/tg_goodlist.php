				...
				<!--<div class="right_title" style="float:left;position:relative;margin-top:-38px;left:125px"><a href="goodlist.php?t=2"<?php echo $t=='2' ? ' class="current"' : '' ?>>商品管理2</a></div>-->
                    ...
                    <div style="padding-bottom: 10px">
                        <form name="search" method="get" action="">
                            商品名称:<input type="text" class="input" name="goodname" style="width:200px" value="<?php echo $goodname ?>" maxlength="30" />
                    ...
                    <form name="cate" method="post" action="?action=saveset">
						...
						-->
                                ...
                                <td class="border_bottom astyle"><a href="<?php $url = "http://{$_SERVER['HTTP_HOST']}";echo $url.'/prt/index.php?id='.$val["linkid"].'&fromid='.$_SESSION["login_userid"];?>" target="_blank">
                                    <?php
                                          $url = "http://{$_SERVER['HTTP_HOST']}";	
                                          echo $url.'/prt/index.php?id='.$val["linkid"].'&fromid='.$_SESSION["login_userid"];
                                    ?>
                                </a></td>
                            </tr>
                            <?php endforeach; ?>
                            <tr>
                                <td colspan="5" class="bg" style="padding-left: 10px;"><?php echo $pagelist ?></td>
                            </tr>
                            <?php else: ?>
                            <tr>
                                <td colspan="5">
