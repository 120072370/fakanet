                    ...
                    <table class="table table-bordered table-responsive" cellspacing="1">
                        <thead>
                            <tr>
                                ...
                                <th class="border_right border_bottom">商户费率</th>
                        ...
                        <tr class="lightbox" id="record_<?php echo $val['id'] ?>">
                            ...
                            <td class="border_bottom" id="t<?php echo $val['id'] ?>">
                                ...
                                <input type="button" onclick="op(<?php echo $val['id'] ?>,1)" class="btn btn-red" value="关闭">

                                <?php else: ?>
                                <input type="button" onclick="op(<?php echo $val['id'] ?>,0)" class="btn btn-success" value="开通">
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
    ...
    var op=function(id,t){
				        ...
				        $.get('channels.php',{action:'op',id:id,t:t},function(data){
				            ...
				            if(t==0){
				                ...
				                $('td#t'+id).html('<input type="button" onclick="op('+id+',0)" class="button_bg_1" value="开通">');
				            }
				            //}
				        })
				    }
