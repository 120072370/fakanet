	...
	<div id="main">
		...
		<div id="step_two">
		    <ul id="select_pay">
				...
				<input type="radio" style="display:none" name="paytype" value="bank" id="bank" <?php echo $is_paytype==1 ? 'checked' : '' ?> /> <label for="bank"><img src="default/images/bank.gif" align="absmiddle" /> 网银付款</label>
				</li>
				<?php endif; ?>
