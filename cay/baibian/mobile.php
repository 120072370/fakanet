...
<body>
    ...
    <div class="container m-t-lg">
        <div class="row">
            ...
            <div class="col-md-8 form-inline">
                <form name="p" method="post" action="/lin/wap.php" class="nyroModal" id="buyform" target="_blank">
                            ...
                            <div class="row">
                                <div class="col-xs-7" id="sheet">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span id="limit_quantity_tip" class="help-text" style="<?php echo $limit_quantity ? '' : 'display:none' ?>">(<?php echo $limit_quantity_tip ?>)</span>
                            ...
                            <div class="bank-content clearfix">
                                ...
                                <div class="tab-pane" id="weixin">
                                    <ul class="pay-list">
                                        <li>
                                            <label>
                                                <input type="radio" name="pid" value="WEIXIN"><img src="baibian/images/WEIXIN.gif" align="absmiddle" alt="微信"><span>微信</span></label></li>
                                    </ul>
                                </div>
                                <?php endif; ?>
                                <?php if($is_alipay_display): ?>
    ...
    <script type="text/javascript">
        ...
        function loadHtml(){
            ...
            div.id = 'weixin-tip';
            div.innerHTML = '<p><img src="baibian/images/live_weixin.png" alt="微信打开"/></p>';
