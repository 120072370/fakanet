...
<head>
    ...
    <link href="/lin/default/css/lin.css" rel="stylesheet" type="text/css">
    ...
    <script src="/lin/default/js/index.js" type="text/javascript"></script>
            ...
            <div class="content">
                    ...
                    <div class="buy_form">
                        ...
                        <div class="form">
                            ...
                            <div class="input_group">
                                ...
                                <input type="number" class="input" min="<?php echo $min_quantity ?>"  onclick="changequantity()" onkeyup="changequantity()" name="quantity" value="<?php echo _G('num') ? _G('num') : ($limit_quantity ? $limit_quantity : 1) ?>" ;"<?php echo $limit_quantity ? ' disabled="disabled" readonly="readonly" title="'.$limit_quantity_tip.'"' : '' ?> />
                            ...
                            <div class="input_group" style="<?php echo $is_coupon ? '' : 'display:none' ?>" id="couponcode">
                ...
                <div class="OnlineInfo form">
                    <div class="buy_info">
                        ...
                        <div class="inter">商家公告</div>
                        <p>
                            <?php echo $siteintr == ""?"商家很懒，没留下任何信息":$siteintr ?>
                        </p>
                        <p>
                            <div class="buy_code qrcodeTable">
                                <dl>
                                    <dt id="qrcodeTable" >
                                    </dt>
                                   <dd  >手机扫描二维码购买</dd>
