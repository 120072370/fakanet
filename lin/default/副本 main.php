...
<body>
    ...
    <form name="p" method="post" class="nyroModal" action="req.php" target="_blank">
        ...
        <div class="choose_goods">
            <div class="content">
                <div class="gonggao">
                    <p style="font-size: 26px; color: #FF3300; font-weight: bold; padding: 15px;"><?php echo $sitename ?></p>
                </div>
		...
		<?php endif; ?>                        </span>
                            ...
                            <div class="input_group">
                                ...
                                <input type="text" class="input" onkeyup="changequantity()" name="quantity" value="<?php echo _G('num') ? _G('num') : ($limit_quantity ? $limit_quantity : 1) ?>" ;"<?php echo $limit_quantity ? ' disabled="disabled" readonly="readonly" title="'.$limit_quantity_tip.'"' : '' ?> />
						...
						<table width="469" border="0" cellpadding="1" cellspacing="1">
                            <tr>
                                <td width="469">
                                    ...
                                    <li style="height:22px;line-height:22px;<?php echo $is_pwdforsearch==1 ? '' : 'display:none' ?>" id="pwdforsearch1"><span class="red">*</span> 取卡密码：<input type="text" class="input" name="pwdforsearch1" style="width: 120px" />
                                        <span style="text-decoration: underline; color: red">(长度为6-20个数字、字母或组合)</span></li>

                                    <li style="height:22px;line-height:22px;<?php echo $is_pwdforsearch==2 ? '' : 'display:none' ?>" id="pwdforsearch2">
                                        <input type="checkbox" name="is_pwdforsearch" value="1" id="is_pwdforsearch" />
                                        <label for="is_pwdforsearch" style="color: red; text-decoration: underline">是否使用取卡密码</label>
                            ...
                            <tr>
                                <td>
                                    <li style="height: 22px; line-height: 22px;">
                                        ...
                                        <label for="isemail">是否成功支付送到邮箱!</label>
                                        <span id="email" style="display: none">Email：<input type="text" class="input" style="padding: 0 3px;" name="email" /></span></li>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <li style="height:22px;line-height:22px;<?php echo $is_coupon ? '' : 'display:none' ?>" id="goodCoupon">
                                        <input type="checkbox" name="is_coupon" value="1" id="is_coupon" />
                                        <label for="is_coupon" style="color: red; text-decoration: underline">是否使用优惠券</label>
                                        <span id="couponcode" style="display: none">请输入优惠券：<input type="text" name="couponcode" class="input" style="padding: 0 3px;" onkeyup="checkCoupon()" /></span> <span id="checkcoupon" style="display: none">
                ...
                <div id="payinfo">
                    <div class="pinfo2" style="display: block;">
                        商品详情:<br>
                        <div class="goodinfo">
                        </div>
                    </div>
                ...
                <div class="charge">
                    ...
                    <div class="choose_charge">
                        <ul>
                            <li class=" active">
                                <input type="radio" style="display: none" name="paytype" value="bank" id="bank" checked /><a href="javascript:void(0);"><img src="/lin/default/images/buy_creditcard.png" /><span>快捷支付</span></a></li>
		...
		<p style="clear: left">
            <div id="protect">
                ...
                <h3>
                    <span class="STYLE2"><span class="STYLE3"><span class="STYLE1">如果您购买以后不会使用售后相关问题，请联系卖家客服QQ:<?php echo $qq ?></span> <a target="blank" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq ?>&Site=<?php echo $sitename ?>&Menu=yes">
                        <img border="0" src="http://wpa.qq.com/pa?p=1:<?php echo $qq ?>:41" alt="点击这里给我发消息" align="absmiddle"></a></span>
            </div>
        </p>
