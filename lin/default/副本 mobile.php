...
<body>
    ...
    <div class="pay_top">
        <p>
            商家名称： <?php echo $sitename ?>
          <br />
            联系商家： <?php echo $qq ?>
        </p>
        <p>
            商家公告:  <?php echo $siteintr == ""?"商家很懒，没留下任何信息":$siteintr ?>
        </p>
    </div>
    <!-- 查询 客服 -->
    <div class="top_btn">
        <a href="/orderquery.htm" target="_blank">
              <img src="/lin/default/images/yc88-net1.png" />订单查询
        </a>
        <a  href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq ?>&Site=<?php echo $sitename ?>&Menu=yes">
           <img src="/lin/default/images/yc88-net2.png" />联系客服
        </a>
    </div>
    ...
    selectgoodid();
            ...
            <p class="pinfo2">
                ...
                <span class="s_right">
                    <a href="javascript:void(0)" id="isdiscount" style="float: left; display: none">查看批发价格
            ...
            <p>
                ...
                <span class="s_right">
                    <input name="contact" type="text" style="height: 40px; width: 85%;" placeholder="建议手机号码，请勿输入123456等数字">
                </span>
            </p>
            ...
            <p>
                ...
                <label for="isemail" style="color: red; text-decoration: underline; font-size: 12px">交易成功后将支付结果发送到我的邮箱</label>
        ...
        <div class="price" id="payinfo">
            应付总额 <span class="red tprice">0.00</span> 元
