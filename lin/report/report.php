...
<head>
    ...
    <title>举报与投诉</title>
    <style type="text/css">
        table.search_result_report {
            padding: 0;
            width: 300px;
        }

            table.search_result_report td {
                padding: 0;
            }

                table.search_result_report td a {
        ...
        div button {
            ...
            background: url(/lin/default/images/botton_bg.gif) no-repeat;
            width: 125px;
            height: 35px;
            border: 0;
            cursor: pointer;
        ...
        .sbbtx {
            ...
            .sbbtx a {
                display: inline-block;
                background: url(/lin/gray/images/x.png) left 13px no-repeat;
                color: #0072e5;
                text-decoration: none;
                padding-left: 15px;
            }
        ...
        .snext {
            width: 81px;
            height: 33px;
            background: url(/lin/gray/images/nextbg.png);
            font-size: 14px;
            color: #FFF;
            font-weight: bold;
            border: none;
        ...
        .stjbtn {
            ...
            width: 125px;
            height: 35px;
            background: url(/lin/gray/images/tjbg.png);
            font-size: 12px;
            color: #000;
            font-weight: bold;
            border: none;
        ...
        .czjb {
            background: url(/lin/gray/images/jbbg.png) 350px 10px no-repeat;
            height: auto;
        }
...
<body>
    <form name='report' action='http://<?php echo _S('HTTP_HOST') ?>/lin/report.php?t=<?php echo $t ?>' method='post' class="nyroModal">
        ...
        <div class="sb">
            ...
            <div class="cz_db">
                <span>*</span>订单号：
      <input type="text" name="report_orderid" size="16" class="ipt" />
                <p><span style="color: red">请填写购买商品的订单号,否则无法为您处理投诉（仅限7天内的订单）</span></p>
            </div>

            <div class="czjb">
                <div class="cz_db" style="padding-top: 10px;">
                    <span>*</span>举报原因：
    <select name="report_type">
        ...
        <option value="其他投诉">其他投诉</option>
                ...
                <div class="cz_db">
                    <span>*</span>联系方式：
      <input type="text" name="report_contact" size="16" class="ipt" />
                ...
                <div class="snextb">
                    <table width="300" class="search_result_report" style="margin: auto">
                        <tr>
                            <td>
                                <input type="submit" name="submit" class="stjbtn" value="提 交" /></td>
                            <td>
                                <input type="button" name="submit" class="stjbtn nyroModalClose" value="关 闭" /></td>
        ...
        <div id="main1">
            <dl class="cuowuDl">
                <span>
                    <img src="http://<?php echo $config['siteurl'] ?>/lin/default/images/cuowu.gif"/></span>
                <dt>
                    <b>举报原因：</b>
                    <select name="report_type">
                        <option value="">--请选择--</option>
                    ...
                    <b>联系方式：</b><input type="text" name="report_contact" size="16" class="J_Select210" />
                    (QQ、E-mail、手机)<br />
