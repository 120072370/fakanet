...
<div class="addr"><span>当前位置：</span><a href="./">首页</a> <span>&raquo;</span> 文章管理  <span>&raquo;</span> 添加新文章</div>
<div class="main">
<!--####新建信息####-->
<style>
#title_color a{display:inline-block;padding:5px 10px;background:#fff;color:#000;text-decoration:none;}
#showstyle{display:none;position:relative;border:1px solid #ccc;background:#f1f1f1;padding:10px;width:680px}
...
<td><input type="text" class="input" name="title" size="100" maxlength="90" /></td>
</tr>
...
<td class="right"></td>
<td>
<input type="checkbox" name="is_bold" id="is_bold" value="bold" /><label for="is_bold"> <strong>加粗显示</strong> </label> 
