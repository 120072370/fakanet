<?php if(!defined('WY_ROOT')) exit;?>
 <div class="addr"><span>当前位置：</span><a href="./">首页</a> <span>&raquo;</span>  订单管理  <span>&raquo;</span> 商户订单分析</div>
<div class="main">
<!--####搜索查询####-->
<form name="s" method="get" action="">
商户名：
<input type="text" class="input" size="12" name="username" value="<?php echo $username ?>" /> 
&nbsp;
...
<td colspan="2" style="text-align:right">当前页统计：</td>
<td><span class="bold"><?php echo $t1 ?></span>条订单</td>
<td><span class="bold"><?php echo $t2 ?></span>条订单</td>
<td><span class="bold"><?php echo $t3 ?></span>条订单</td>
...
foreach($lists as $key=>$val):
    $t1=$t1+$val['total_orders'];
    $t2=$t2+$val['success_orders'];
    $t3=$t3+$val['fail_orders'];
    $t4=$t4+$val['total_money'];
    $t5=$t5+$val['success_money'];
    $t6=$t6+$val['income_money'];
    $t7=$t7+$val['sys_income_money'];
endforeach;
endif;
?>
<tr class="whitebg" style="background-color:yellow">
<td style="text-align:right">总统计：</td>
<td>共<span class="bold"><?php echo $totalsize ?></span>个商户</td>
<td><span class="bold"><?php echo $t1 ?></span>条订单</td>
<td><span class="bold"><?php echo $t2 ?></span>条订单</td>
<td><span class="bold"><?php echo $t3 ?></span>条订单</td>
<td><span class="bold"><?php echo number_format($t4,2,'.','') ?></span>元</td>
...
<!--<tr><td colspan="9" class="h30 graybg"></td></tr>-->
</form>
<?php endif; ?>
</table>
</div>