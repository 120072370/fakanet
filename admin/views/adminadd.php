...
?>
<div class="addr"><span>当前位置：</span><a href="./">首页</a> <span>&raquo;</span> <a href="adminList.php">管理员列表</a>  <span>&raquo;</span> 添加新账号</div>
<div class="main"> 
<style>
...
?>
<td><input type="checkbox" name="adminlimit['<?php echo $key ?>']" id="<?php echo $key ?>" value="<?php echo $key ?>"><label for="<?php echo $key ?>"><?php echo $val ?></label></td>
<?php
if($i%3==0) echo '</tr><tr>';
$i++;
endforeach;
...
$(function(){
  ...
  $('[type=submit]').click(function(){
	...
	if(username=='' || username.length<5 || username.length>20){
	  $('#err_msg_1').html('登陆账号不能为空！长度在5-20个字符之间！').show();
	  $('[name=username]').focus();
	  return false;
	}
