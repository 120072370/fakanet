...
<div style="padding:10px;width:350px">
	...
	<tr>
	<td class="right bg" width="70">登陆用户：</td>
...
至 <input type="text" name="tdate" class="input" id="txtDate1" onclick="SelectDate(this)" size="12" readonly="readonly" value="<?php echo $tdate ?>" /></td>
	...
	<td><input type="submit" class="button_bg_2" onclick="if(confirm('是否要执行此操作？')){form1.submit();}else{return false;}" value="清除记录" /></td>
	</tr>
	</table>
	</form>

    <?php elseif($t=='message'): ?>
	<form name="form1" method="post" action="?action=exedeldata">
    <table class="tablelistinfo" cellspacing="1">
	<tr>
	<td class="right bg" width="70">选择类别：</td>
...
至 <input type="text" name="tdate" class="input" id="txtDate1" onclick="SelectDate(this)" size="12" readonly="readonly" value="<?php echo $tdate ?>" /></td>
	...
	<tr>
	<td class="right bg"></td>
	<td><input type="submit" class="button_bg_2" onclick="if(confirm('是否要执行此操作？')){form1.submit();}else{return false;}" value="关闭订单" /></td>
	</tr>
	</table>
	</form>
