...
?>
<div class="addr"><span>当前位置：</span><a href="./">首页</a> <span>&raquo;</span> <a href="adminList.php">管理员列表</a>  <span>&raquo;</span> 编辑账号</div>
<div class="main"> 
<style>
...
?>
<td><input type="checkbox" name="adminlimit['<?php echo $key ?>']" <?php echo in_array($key,$adminlimit) ? 'checked' : '' ?> id="<?php echo $key ?>" value="<?php echo $key ?>"><label for="<?php echo $key ?>"><?php echo $val ?></label></td>
<?php
if($i%3==0) echo '</tr><tr>';
$i++;
endforeach;
