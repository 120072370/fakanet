...
setTimeout(hideMsg,2600);
 ...
 <div class="addr"><span>当前位置：</span><a href="./">首页</a> <span>&raquo;</span> 管理员管理  <span>&raquo;</span> 登陆日志</div>
<div class="main">
<!--####搜索查询####-->
...
<input type="button" onclick="Boxy.load('?action=deldatalogs&username=<?php echo $username ?>&fdate=<?php echo $fdate ?>&tdate=<?php echo $tdate ?>',{title:'清除登陆日志'})"  class="button_bg_2" value="清除日志" />
...
<td class="center">
<a href="<?php echo "?action=dellogs&id=".$row['id'] ?>" onclick="if(!confirm('是否要执行 删除 操作？'))return false"><img src="views/images/ico_del.png"></a>
</td>
</tr>
<?php endforeach;?>
