            ...
            if (tokid != "") {
                mqq.tenpay.pay({
                    ...
                    if (resultCode == 0) {
                        ...
                        alert("支付成功，请点击订单号查询，如有延迟，请稍后查询！");
                        //location.href = '/orderquery.htm?st=orderid&kw=<?php echo $attach?>';
                    }
                });
            }
...
<body>
    <table border="0" width="740" cellspacing="0" cellpadding="0" align="center">
        <tr>
            <td height="78" align="center" valign="middle"><span id="res" style="font-size: 14px; color: #000;">
                交易订单号：
                <a href="/orderquery.htm?st=orderid&kw=<?php echo $attach?>" target="_blank">
                <?=$attach?></a></span>&nbsp;&nbsp;<span style="font-size: 14px; color: #000;">金额：<?=$amount?>元</span></td>
        </tr>
        <tr>
